...
private val testInput = "R5, L5, R5, R3"
...
fun first() {
    ...
    val distance = calcDistance(xCoordinate, yCoordinate)
    println("Distance to the endpoint is $distance")
}

fun second() {
    val input = startInput1.split(',')
    for (arg in input) {
        chooseTurn(arg.trim())
    }
